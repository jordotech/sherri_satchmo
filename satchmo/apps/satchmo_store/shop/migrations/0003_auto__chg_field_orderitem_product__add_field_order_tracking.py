...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_orderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product'], on_delete=models.PROTECT))
        # Adding field 'Order.tracking'
        db.add_column('shop_order', 'tracking',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrderItem.product'
        db.alter_column('shop_orderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product']))
        # Deleting field 'Order.tracking'
        db.delete_column('shop_order', 'tracking')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'tracking': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        ...
        'shop.orderitem': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.Product']", 'on_delete': 'models.PROTECT'}),
            'quantity': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '6'}),
