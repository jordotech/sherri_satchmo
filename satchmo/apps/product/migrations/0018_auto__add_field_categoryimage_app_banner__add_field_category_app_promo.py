...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryImage.app_banner'
        db.add_column('product_categoryimage', 'app_banner',
                      self.gf(u'satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=200, name_field='_filename', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.app_promo_text'
        db.add_column('product_category', 'app_promo_text',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryImage.app_banner'
        db.delete_column('product_categoryimage', 'app_banner')

        # Deleting field 'Category.app_promo_text'
        db.delete_column('product_category', 'app_promo_text')
    ...
    models = {
        ...
        'product.category': {
            ...
            'app_collection': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'app_promo_text': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'product.categoryimage': {
            ...
            'app_banner': (u'satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'max_length': '200', 'name_field': "'_filename'", 'null': 'True', 'blank': 'True'}),
            'banner': (u'satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'max_length': '200', 'name_field': "'_filename'", 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picture': (u'satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'max_length': '200', 'name_field': "'_filename'", 'null': 'True', 'blank': 'True'}),
