...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryImage.banner'
        db.add_column('product_categoryimage', 'banner',
                      self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=200, name_field='_filename', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryImage.banner'
        db.delete_column('product_categoryimage', 'banner')
