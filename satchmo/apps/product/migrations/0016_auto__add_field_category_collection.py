...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.collection'
        db.add_column('product_category', 'collection',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.collection'
        db.delete_column('product_category', 'collection')
    ...
    models = {
        ...
        'product.category': {
            ...
            'collection': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
