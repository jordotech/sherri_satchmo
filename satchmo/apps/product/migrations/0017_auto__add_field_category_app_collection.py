...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.app_collection'
        db.add_column('product_category', 'app_collection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.app_collection'
        db.delete_column('product_category', 'app_collection')
