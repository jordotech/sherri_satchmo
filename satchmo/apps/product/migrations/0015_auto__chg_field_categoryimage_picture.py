...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CategoryImage.picture'
        db.alter_column('product_categoryimage', 'picture', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=200, name_field='_filename', null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CategoryImage.picture'
        raise RuntimeError("Cannot reverse this migration. 'CategoryImage.picture' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CategoryImage.picture'
        db.alter_column('product_categoryimage', 'picture', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(name_field='_filename', max_length=200))
    ...
    models = {
        ...
        'product.categoryimage': {
            ...
            'banner': ('satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'max_length': '200', 'name_field': "'_filename'", 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picture': ('satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'max_length': '200', 'name_field': "'_filename'", 'null': 'True', 'blank': 'True'}),
